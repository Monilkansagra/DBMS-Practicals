...
EXEC SP_RENAME 'DEPOSIT','DEPOSIT_DATIAL'
--------------PART-B OF ALTER-----------
...
EXEC SP_RENAME 'DEPOSIT_DATIAL.CNAME','CUSTOMERNAME'
...
EXP SP_RENAME 'STUDENT_DATIAL','STUDENT_MASTER'
...
INSERT INTO EMPLOYEE_MASTER VALUES(101,'KEYUR','2002-1-5',12000,'RAJKOT'),
							      (102,'HARDIK','2004-2-15',14000,'AHEMDABAD'),
								  (103,'KAJAL','2006-3-14',15000,'BARODA'),
								  (104,'BHOOMI','2005-6-23',12500,'AHEMDABAD'),
								  (105,'HARMIT','2004-2-15',14000,'RAJKOT'),
								  (106,'MITESH','2001-9-25',5000,'JAMNAGAR'),
								  (107,'MERRA',NULL,7000,'MORBI'),
								  (108,'KISHAN','2003-3-6',10000,NULL);
