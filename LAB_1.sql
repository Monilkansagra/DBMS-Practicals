...
(107,'SHIVANI','VIRRAR',1000.00,'1995-09-05'),
(108,'KRANTI','NAHERU PLACE',5000.00,'1995-07-02'),
...
SELECT DISTINCT BNAME,CITY FROM CUSTOMERS
--6. Retrieve all Loan records with one more column in Loan Amount as 10% extra amount. 
SELECT *,(AMOUNT +(AMOUNT*0.10))AS NEW_COLOMN FROM BORROW
